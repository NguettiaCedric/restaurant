...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.categories.index')->with('success','Catégorie enregistrée avec succès.');
    }
    ...
    public function update(Request $request, category $category)
    {
       ...
       $category->update([
        ...
        return to_route('admin.categories.index')->with('warning','Catégorie modifiée avec succès.');
    }
    ...
    public function destroy(category $category)
    {
        ...
        $category->delete();
        return redirect()->route('admin.categories.index')->with('danger', 'Catégorie supprimée avec succès.');
