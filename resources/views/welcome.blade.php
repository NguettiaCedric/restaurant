<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        ...
        <h1
            ...
            <span class="inline md:block">Bienvenue chez DricoFood la merveille des délices</span>
        </h1>
        ...
        <div class="flex flex-col items-center mt-12 text-center">
            <span class="relative inline-flex w-full md:w-auto">
                <a href="{{ route('reservation.etape-1') }}" type="button"
    ...
    <section class="mt-8 bg-white">
        <div class="mt-4 text-center">
            <h3 class="text-2xl font-bold">Nos Menus</h3>
            <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                SPECIALITES DU JOURS
            </h2>
        </div>
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
          ...
          > -->
                        ...
                        <h2 class="text-4xl text-green-600">Bienvenue</h2>
                        <!-- </h1> -->
                    ...
                    <div class="w-full lg:max-w-md">
                        ...
                        <ul>
                            ...
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">100% à votre écoute</span>
                            </li>
                        </ul>
                    </div>
                </div>
