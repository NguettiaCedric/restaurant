            ...
            <div class="flex-1 h-full max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            <h3 class="mb-4 text-xl font-bold text-blue-600">Faire une reservation</h3>
                            ...
                            <form method="POST" action="{{ route('reservation.store.etape-1') }}">
                                @csrf
                                ...
                                <div class="sm:col-span-6">
                                    <label for="tel_number" class="block text-sm font-medium text-gray-700">
                                        Télephone <span class="text-red-500">*</span>
                                    </label>
                                    <div class="mt-1">
                                ...
                                <div class="sm:col-span-6">
                                    <label for="res_date" class="block text-sm font-medium text-gray-700">
                                        Date Reservation <span class="text-red-500">*</span>
                                    </label>
                                    <div class="mt-1">
                                    ...
                                    <span class="text-xs">SVP veuillez entrer une heure 11:00-23:00.</span>
                                    @error('res_date')
                                        <div class="text-sm text-red-400">{{ $message }}</div>
                                    @enderror
                                </div>
